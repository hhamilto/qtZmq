...
/*
  var incrementalFeeder = require("qt-zmq");
  incrementalFeeder.onMessage = function(message){
    //ready = false
    messageHandlers.incremental(message);
    incrementalFeeder.doReceive();
  }
  incrementalFeeder.connect(ZMQBaseAddress+socketInfo.incremental);
  incrementalFeeder.doReceive();
